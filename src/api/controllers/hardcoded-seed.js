...
const importHardcodedData = async (req, res) => {
  try {
    ...
    // Priročni aliasi
    const [admin, ana, marko, eva, tim, sara, luka, nika] = users;
    ...
    const [kavaMeeting, pohodMeeting, boardGamesMeeting, jogaMeeting, filmMeeting, kolesarjenjeMeeting, umetnostMeeting] = meetings;
